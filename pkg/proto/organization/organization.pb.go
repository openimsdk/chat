...
type CreateDepartmentReq struct {
	...
	DepartmentInfo *common.Department `protobuf:"bytes,3,opt,name=departmentInfo,proto3" json:"departmentInfo,omitempty"`
}
...
type CreateDepartmentResp struct {
	...
	CommonResp     *common.CommonResp `protobuf:"bytes,1,opt,name=commonResp,proto3" json:"commonResp,omitempty"`
	DepartmentInfo *common.Department `protobuf:"bytes,2,opt,name=departmentInfo,proto3" json:"departmentInfo,omitempty"`
}
...
type DepartmentInfo struct {
	...
	Department        *common.Department `protobuf:"bytes,1,opt,name=department,proto3" json:"department,omitempty"`
	SubDepartmentList []*DepartmentInfo  `protobuf:"bytes,2,rep,name=subDepartmentList,proto3" json:"subDepartmentList,omitempty"`
}
...
type GetOrganizationDepartmentResp struct {
	...
	CommonResp     *common.CommonResp `protobuf:"bytes,1,opt,name=commonResp,proto3" json:"commonResp,omitempty"`
	DepartmentList []*DepartmentInfo  `protobuf:"bytes,2,rep,name=departmentList,proto3" json:"departmentList,omitempty"`
}
...
type DeleteDepartmentReq struct {
	...
	OperationID      string   `protobuf:"bytes,1,opt,name=operationID,proto3" json:"operationID,omitempty"`
	OpUserID         string   `protobuf:"bytes,2,opt,name=opUserID,proto3" json:"opUserID,omitempty"`
	DepartmentIDList []string `protobuf:"bytes,3,rep,name=departmentIDList,proto3" json:"departmentIDList,omitempty"`
}
...
type GetDepartmentParentIDListResp struct {
	...
	CommonResp   *common.CommonResp `protobuf:"bytes,1,opt,name=commonResp,proto3" json:"commonResp,omitempty"`
	ParentIDList []string           `protobuf:"bytes,2,rep,name=parentIDList,proto3" json:"parentIDList,omitempty"`
}
...
type CreateOrganizationUserReq struct {
	...
	OperationID      string                   `protobuf:"bytes,1,opt,name=operationID,proto3" json:"operationID,omitempty"`
	OpUserID         string                   `protobuf:"bytes,2,opt,name=opUserID,proto3" json:"opUserID,omitempty"`
	OrganizationUser *common.OrganizationUser `protobuf:"bytes,3,opt,name=organizationUser,proto3" json:"organizationUser,omitempty"`
}
...
type CreateDepartmentMemberReq struct {
	...
	OperationID      string                   `protobuf:"bytes,1,opt,name=operationID,proto3" json:"operationID,omitempty"`
	OpUserID         string                   `protobuf:"bytes,2,opt,name=opUserID,proto3" json:"opUserID,omitempty"`
	DepartmentMember *common.DepartmentMember `protobuf:"bytes,3,opt,name=departmentMember,proto3" json:"departmentMember,omitempty"`
}
...
type GetUserInDepartmentResp struct {
	...
	CommonResp       *common.CommonResp       `protobuf:"bytes,1,opt,name=commonResp,proto3" json:"commonResp,omitempty"`
	UserInDepartment *common.UserInDepartment `protobuf:"bytes,3,opt,name=userInDepartment,proto3" json:"userInDepartment,omitempty"`
}
...
type GetUserInOrganizationResp struct {
	...
	CommonResp        *common.CommonResp         `protobuf:"bytes,1,opt,name=commonResp,proto3" json:"commonResp,omitempty"`
	OrganizationUsers []*common.OrganizationUser `protobuf:"bytes,3,rep,name=organizationUsers,proto3" json:"organizationUsers,omitempty"`
}
...
type CompleteOrganization struct {
	...
	PeopleNumber   uint32                  `protobuf:"varint,1,opt,name=peopleNumber,proto3" json:"peopleNumber,omitempty"`
	List           []*CompleteOrganization `protobuf:"bytes,2,rep,name=list,proto3" json:"list,omitempty"`
	...
	DepartmentType int32                   `protobuf:"varint,8,opt,name=departmentType,proto3" json:"departmentType,omitempty"`
...
type GetCompleteOrganizationResp struct {
	...
	CommonResp *common.CommonResp      `protobuf:"bytes,1,opt,name=commonResp,proto3" json:"commonResp,omitempty"`
	List       []*CompleteOrganization `protobuf:"bytes,3,rep,name=list,proto3" json:"list,omitempty"`
}
...
type GetUsersInDepartmentResp struct {
	...
	CommonResp *common.CommonResp         `protobuf:"bytes,1,opt,name=commonResp,proto3" json:"commonResp,omitempty"`
	List       []*common.UserInDepartment `protobuf:"bytes,3,rep,name=list,proto3" json:"list,omitempty"`
}
...
type GetSearchUserListReq struct {
	...
	ShowNumber       uint32                   `protobuf:"varint,4,opt,name=showNumber,proto3" json:"showNumber,omitempty"`
	Text             string                   `protobuf:"bytes,5,opt,name=text,proto3" json:"text,omitempty"`
	Sorts            []*GetSearchUserListSort `protobuf:"bytes,6,rep,name=sorts,proto3" json:"sorts,omitempty"`
	DepartmentIDList []string                 `protobuf:"bytes,7,rep,name=departmentIDList,proto3" json:"departmentIDList,omitempty"`
	PositionList     []string                 `protobuf:"bytes,8,rep,name=positionList,proto3" json:"positionList,omitempty"`
}
...
type GetSearchUserListResp struct {
	...
	CommonResp *common.CommonResp         `protobuf:"bytes,1,opt,name=commonResp,proto3" json:"commonResp,omitempty"`
	UserList   []*common.UserInDepartment `protobuf:"bytes,2,rep,name=userList,proto3" json:"userList,omitempty"`
...
type GetSubDepartmentResp struct {
	...
	CommonResp              *common.CommonResp         `protobuf:"bytes,1,opt,name=commonResp,proto3" json:"commonResp,omitempty"`
	DepartmentMemberList    []*common.DepartmentMember `protobuf:"bytes,2,rep,name=departmentMemberList,proto3" json:"departmentMemberList,omitempty"`
	DepartmentList          []*common.Department       `protobuf:"bytes,3,rep,name=departmentList,proto3" json:"departmentList,omitempty"`
	DepartmentDirectoryList []*common.Department       `protobuf:"bytes,4,rep,name=departmentDirectoryList,proto3" json:"departmentDirectoryList,omitempty"`
}
...
type GetSearchDepartmentUserReq struct {
	...
	IsGetAllDepartment bool   `protobuf:"varint,4,opt,name=IsGetAllDepartment,proto3" json:"IsGetAllDepartment,omitempty"`
}
...
type GetSearchDepartmentUserOrganizationUser struct {
	...
	OrganizationUser *common.OrganizationUser `protobuf:"bytes,1,opt,name=organizationUser,proto3" json:"organizationUser,omitempty"`
	DepartmentList   []*common.Department     `protobuf:"bytes,2,rep,name=departmentList,proto3" json:"departmentList,omitempty"`
...
type GetSearchDepartmentUserResp struct {
	...
	CommonResp           *common.CommonResp                         `protobuf:"bytes,1,opt,name=commonResp,proto3" json:"commonResp,omitempty"`
	DepartmentList       []*common.Department                       `protobuf:"bytes,2,rep,name=departmentList,proto3" json:"departmentList,omitempty"`
	OrganizationUserList []*GetSearchDepartmentUserOrganizationUser `protobuf:"bytes,3,rep,name=organizationUserList,proto3" json:"organizationUserList,omitempty"`
}
...
type SortDepartmentListReq struct {
	...
	NextDepartmentID string `protobuf:"bytes,5,opt,name=nextDepartmentID,proto3" json:"nextDepartmentID,omitempty"`
}
...
type SortOrganizationUserListReq struct {
	...
	NextUserID   string `protobuf:"bytes,5,opt,name=nextUserID,proto3" json:"nextUserID,omitempty"`
}
...
type GetDepartmentResp struct {
	...
	CommonResp *common.CommonResp `protobuf:"bytes,1,opt,name=commonResp,proto3" json:"commonResp,omitempty"`
	Department *common.Department `protobuf:"bytes,2,opt,name=department,proto3" json:"department,omitempty"`
}
...
type CreateNewOrganizationMemberReq struct {
	...
	OpUserID             string                     `protobuf:"bytes,2,opt,name=opUserID,proto3" json:"opUserID,omitempty"`
	OrganizationUser     *common.OrganizationUser   `protobuf:"bytes,3,opt,name=organizationUser,proto3" json:"organizationUser,omitempty"`
	DepartmentMemberList []*common.DepartmentMember `protobuf:"bytes,4,rep,name=departmentMemberList,proto3" json:"departmentMemberList,omitempty"`
	UserIdentity         *common.UserIdentity       `protobuf:"bytes,5,opt,name=userIdentity,proto3" json:"userIdentity,omitempty"`
}
...
type GetUserInfoResp struct {
	...
	CommonResp *common.CommonResp       `protobuf:"bytes,1,opt,name=commonResp,proto3" json:"commonResp,omitempty"`
	User       *common.OrganizationUser `protobuf:"bytes,2,opt,name=user,proto3" json:"user,omitempty"`
}
...
type BatchImportUserDepartmentName struct {
	...
	HierarchyName []string `protobuf:"bytes,1,rep,name=hierarchyName,proto3" json:"hierarchyName,omitempty"`
}
...
type BatchImportUser struct {
	...
	UserDepartmentNameList []*BatchImportUserDepartmentNamePosition `protobuf:"bytes,12,rep,name=userDepartmentNameList,proto3" json:"userDepartmentNameList,omitempty"`
	...
	Station                string                                   `protobuf:"bytes,16,opt,name=station,proto3" json:"station,omitempty"`
}
...
type BatchImportDepartment struct {
	...
	ParentDepartmentName *BatchImportUserDepartmentName `protobuf:"bytes,11,opt,name=parentDepartmentName,proto3" json:"parentDepartmentName,omitempty"`
}
...
type BatchImportReq struct {
	...
	OperationID    string                   `protobuf:"bytes,1,opt,name=operationID,proto3" json:"operationID,omitempty"`
	OpUserID       string                   `protobuf:"bytes,2,opt,name=opUserID,proto3" json:"opUserID,omitempty"`
	UserList       []*BatchImportUser       `protobuf:"bytes,3,rep,name=userList,proto3" json:"userList,omitempty"`
	DepartmentList []*BatchImportDepartment `protobuf:"bytes,4,rep,name=departmentList,proto3" json:"departmentList,omitempty"`
}
...
type MoveUserDepartment struct {
	...
	CurrentDepartmentID string `protobuf:"bytes,3,opt,name=currentDepartmentID,proto3" json:"currentDepartmentID,omitempty"`
	Position            string `protobuf:"bytes,4,opt,name=position,proto3" json:"position,omitempty"`
	Leader              int32  `protobuf:"varint,5,opt,name=leader,proto3" json:"leader,omitempty"`
	Status              int32  `protobuf:"varint,6,opt,name=status,proto3" json:"status,omitempty"`
	EntryTime           int64  `protobuf:"varint,7,opt,name=entryTime,proto3" json:"entryTime,omitempty"`
...
type MoveUserDepartmentReq struct {
	...
	OperationID            string                `protobuf:"bytes,1,opt,name=operationID,proto3" json:"operationID,omitempty"`
	OpUserID               string                `protobuf:"bytes,2,opt,name=opUserID,proto3" json:"opUserID,omitempty"`
	MoveUserDepartmentList []*MoveUserDepartment `protobuf:"bytes,3,rep,name=moveUserDepartmentList,proto3" json:"moveUserDepartmentList,omitempty"`
}
...
type GetUserFullListReq struct {
	...
	UserIDList  []string `protobuf:"bytes,5,rep,name=userIDList,proto3" json:"userIDList,omitempty"`
}
...
type GetUserFullListResp struct {
	...
	CommonResp           *common.CommonResp         `protobuf:"bytes,1,opt,name=commonResp,proto3" json:"commonResp,omitempty"`
	OrganizationUserList []*common.OrganizationUser `protobuf:"bytes,2,rep,name=organizationUserList,proto3" json:"organizationUserList,omitempty"`
...
type SearchUsersFullInfoReq struct {
	...
	Operation      *common.Operation         `protobuf:"bytes,1,opt,name=operation,proto3" json:"operation,omitempty"`
	Pagination     *common.RequestPagination `protobuf:"bytes,2,opt,name=pagination,proto3" json:"pagination,omitempty"`
	UserPublicInfo *common.UserPublicInfo    `protobuf:"bytes,3,opt,name=userPublicInfo,proto3" json:"userPublicInfo,omitempty"`
