...
type Department struct {
	...
	RelatedGroupID string `protobuf:"bytes,7,opt,name=relatedGroupID,proto3" json:"relatedGroupID,omitempty"`
...
type OrganizationUser struct {
	...
	DepartmentMemberList []*DepartmentMember `protobuf:"bytes,14,rep,name=departmentMemberList,proto3" json:"departmentMemberList,omitempty"`
	Station              string              `protobuf:"bytes,15,opt,name=station,proto3" json:"station,omitempty"`
	AreaCode             string              `protobuf:"bytes,16,opt,name=areaCode,proto3" json:"areaCode,omitempty"`
}
...
type DepartmentMember struct {
	...
	EntryTime        int64             `protobuf:"varint,8,opt,name=entryTime,proto3" json:"entryTime,omitempty"`
	TerminationTime  int64             `protobuf:"varint,9,opt,name=terminationTime,proto3" json:"terminationTime,omitempty"`
	CreateTime       int64             `protobuf:"varint,10,opt,name=createTime,proto3" json:"createTime,omitempty"`
	Department       *Department       `protobuf:"bytes,11,opt,name=department,proto3" json:"department,omitempty"`
	OrganizationUser *OrganizationUser `protobuf:"bytes,12,opt,name=organizationUser,proto3" json:"organizationUser,omitempty"`
}
...
type Organization struct {
	...
	RelatedGroupID  string `protobuf:"bytes,4,opt,name=relatedGroupID,proto3" json:"relatedGroupID,omitempty"`
	Introduction    string `protobuf:"bytes,5,opt,name=introduction,proto3" json:"introduction,omitempty"`
	CreateTime      int64  `protobuf:"varint,6,opt,name=createTime,proto3" json:"createTime,omitempty"`
	DefaultPassword int64  `protobuf:"varint,7,opt,name=defaultPassword,proto3" json:"defaultPassword,omitempty"`
}
