...
echo "start running admin_rpc_starts.sh..."
#Include shell font styles and some basic information
echo "start sourcing resources"
source ./style_info.cfg
source ./path_info.cfg
source ./function.sh
echo "source resources ending"
echo ""
...
sleep 1
cd ${push_binary_root}
echo "services checking finished"

echo "start back-end launching services... continue appending log file to logs/openIM.log"
